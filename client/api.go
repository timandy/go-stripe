...
import (
	...
	"github.com/timandy/go-stripe/v72/account"
	"github.com/timandy/go-stripe/v72/accountlink"
	"github.com/timandy/go-stripe/v72/applepaydomain"
	appssecret "github.com/timandy/go-stripe/v72/apps/secret"
	"github.com/timandy/go-stripe/v72/balance"
	"github.com/timandy/go-stripe/v72/balancetransaction"
	"github.com/timandy/go-stripe/v72/bankaccount"
	billingportalconfiguration "github.com/timandy/go-stripe/v72/billingportal/configuration"
	billingportalsession "github.com/timandy/go-stripe/v72/billingportal/session"
	"github.com/timandy/go-stripe/v72/capability"
	"github.com/timandy/go-stripe/v72/card"
	"github.com/timandy/go-stripe/v72/cashbalance"
	"github.com/timandy/go-stripe/v72/charge"
	checkoutsession "github.com/timandy/go-stripe/v72/checkout/session"
	"github.com/timandy/go-stripe/v72/countryspec"
	"github.com/timandy/go-stripe/v72/coupon"
	"github.com/timandy/go-stripe/v72/creditnote"
	"github.com/timandy/go-stripe/v72/customer"
	"github.com/timandy/go-stripe/v72/customerbalancetransaction"
	"github.com/timandy/go-stripe/v72/discount"
	"github.com/timandy/go-stripe/v72/dispute"
	"github.com/timandy/go-stripe/v72/ephemeralkey"
	"github.com/timandy/go-stripe/v72/event"
	"github.com/timandy/go-stripe/v72/fee"
	"github.com/timandy/go-stripe/v72/feerefund"
	"github.com/timandy/go-stripe/v72/file"
	"github.com/timandy/go-stripe/v72/filelink"
	financialconnectionsaccount "github.com/timandy/go-stripe/v72/financialconnections/account"
	financialconnectionssession "github.com/timandy/go-stripe/v72/financialconnections/session"
	identityverificationreport "github.com/timandy/go-stripe/v72/identity/verificationreport"
	identityverificationsession "github.com/timandy/go-stripe/v72/identity/verificationsession"
	"github.com/timandy/go-stripe/v72/invoice"
	"github.com/timandy/go-stripe/v72/invoiceitem"
	issuingauthorization "github.com/timandy/go-stripe/v72/issuing/authorization"
	issuingcard "github.com/timandy/go-stripe/v72/issuing/card"
	issuingcardholder "github.com/timandy/go-stripe/v72/issuing/cardholder"
	issuingdispute "github.com/timandy/go-stripe/v72/issuing/dispute"
	issuingtransaction "github.com/timandy/go-stripe/v72/issuing/transaction"
	"github.com/timandy/go-stripe/v72/loginlink"
	"github.com/timandy/go-stripe/v72/mandate"
	"github.com/timandy/go-stripe/v72/oauth"
	"github.com/timandy/go-stripe/v72/order"
	"github.com/timandy/go-stripe/v72/orderreturn"
	"github.com/timandy/go-stripe/v72/paymentintent"
	"github.com/timandy/go-stripe/v72/paymentlink"
	"github.com/timandy/go-stripe/v72/paymentmethod"
	"github.com/timandy/go-stripe/v72/paymentsource"
	"github.com/timandy/go-stripe/v72/payout"
	"github.com/timandy/go-stripe/v72/person"
	"github.com/timandy/go-stripe/v72/plan"
	"github.com/timandy/go-stripe/v72/price"
	"github.com/timandy/go-stripe/v72/product"
	"github.com/timandy/go-stripe/v72/promotioncode"
	"github.com/timandy/go-stripe/v72/quote"
	radarearlyfraudwarning "github.com/timandy/go-stripe/v72/radar/earlyfraudwarning"
	radarvaluelist "github.com/timandy/go-stripe/v72/radar/valuelist"
	radarvaluelistitem "github.com/timandy/go-stripe/v72/radar/valuelistitem"
	"github.com/timandy/go-stripe/v72/refund"
	reportingreportrun "github.com/timandy/go-stripe/v72/reporting/reportrun"
	reportingreporttype "github.com/timandy/go-stripe/v72/reporting/reporttype"
	"github.com/timandy/go-stripe/v72/reversal"
	"github.com/timandy/go-stripe/v72/review"
	"github.com/timandy/go-stripe/v72/setupattempt"
	"github.com/timandy/go-stripe/v72/setupintent"
	"github.com/timandy/go-stripe/v72/shippingrate"
	sigmascheduledqueryrun "github.com/timandy/go-stripe/v72/sigma/scheduledqueryrun"
	"github.com/timandy/go-stripe/v72/sku"
	"github.com/timandy/go-stripe/v72/source"
	"github.com/timandy/go-stripe/v72/sourcetransaction"
	"github.com/timandy/go-stripe/v72/sub"
	"github.com/timandy/go-stripe/v72/subitem"
	"github.com/timandy/go-stripe/v72/subschedule"
	"github.com/timandy/go-stripe/v72/taxcode"
	"github.com/timandy/go-stripe/v72/taxid"
	"github.com/timandy/go-stripe/v72/taxrate"
	terminalconfiguration "github.com/timandy/go-stripe/v72/terminal/configuration"
	terminalconnectiontoken "github.com/timandy/go-stripe/v72/terminal/connectiontoken"
	terminallocation "github.com/timandy/go-stripe/v72/terminal/location"
	terminalreader "github.com/timandy/go-stripe/v72/terminal/reader"
	testhelperscustomer "github.com/timandy/go-stripe/v72/testhelpers/customer"
	testhelpersrefund "github.com/timandy/go-stripe/v72/testhelpers/refund"
	testhelpersterminalreader "github.com/timandy/go-stripe/v72/testhelpers/terminal/reader"
	testhelperstestclock "github.com/timandy/go-stripe/v72/testhelpers/testclock"
	testhelperstreasuryinboundtransfer "github.com/timandy/go-stripe/v72/testhelpers/treasury/inboundtransfer"
	testhelperstreasuryoutboundpayment "github.com/timandy/go-stripe/v72/testhelpers/treasury/outboundpayment"
	testhelperstreasuryoutboundtransfer "github.com/timandy/go-stripe/v72/testhelpers/treasury/outboundtransfer"
	testhelperstreasuryreceivedcredit "github.com/timandy/go-stripe/v72/testhelpers/treasury/receivedcredit"
	testhelperstreasuryreceiveddebit "github.com/timandy/go-stripe/v72/testhelpers/treasury/receiveddebit"
	"github.com/timandy/go-stripe/v72/token"
	"github.com/timandy/go-stripe/v72/topup"
	"github.com/timandy/go-stripe/v72/transfer"
	treasurycreditreversal "github.com/timandy/go-stripe/v72/treasury/creditreversal"
	treasurydebitreversal "github.com/timandy/go-stripe/v72/treasury/debitreversal"
	treasuryfinancialaccount "github.com/timandy/go-stripe/v72/treasury/financialaccount"
	treasuryinboundtransfer "github.com/timandy/go-stripe/v72/treasury/inboundtransfer"
	treasuryoutboundpayment "github.com/timandy/go-stripe/v72/treasury/outboundpayment"
	treasuryoutboundtransfer "github.com/timandy/go-stripe/v72/treasury/outboundtransfer"
	treasuryreceivedcredit "github.com/timandy/go-stripe/v72/treasury/receivedcredit"
	treasuryreceiveddebit "github.com/timandy/go-stripe/v72/treasury/receiveddebit"
	treasurytransaction "github.com/timandy/go-stripe/v72/treasury/transaction"
	treasurytransactionentry "github.com/timandy/go-stripe/v72/treasury/transactionentry"
	"github.com/timandy/go-stripe/v72/usagerecord"
	"github.com/timandy/go-stripe/v72/usagerecordsummary"
	"github.com/timandy/go-stripe/v72/webhookendpoint"
)
